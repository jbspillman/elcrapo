...
def get_releases():
    ...
    os.makedirs(os.path.join(script_folder, '00_installers'), exist_ok=True)

    releases_file_name = os.path.join(script_folder, '00_installers', 'releases.html')
    versions_file_name = os.path.join(script_folder, '00_installers', 'versions.html')

    rpm_release = os.path.join(script_folder, '00_installers', 'elbencho-static.x86_64.rpm')
    deb_release = os.path.join(script_folder, '00_installers', 'elbencho-static_amd64.deb')
    zip_release = os.path.join(script_folder, '00_installers', 'elbencho-windows.zip')
    ...
    if not os.path.exists(rpm_release) or not os.path.exists(deb_release) or not os.path.exists(zip_release):
        ...
        if response.status_code == 200:
            ...
            for download_url in downloads_list:
                ...
                local_file_path = os.path.join(script_folder, '00_installers', file_name)
